...
2. **a** & **b** are loads, **x** is a byte read by both **a** & **b**, there is no store to **x** between **a** & **b** in 
...
3. a is a generated by AMO or SC instructions. b is a load and b returns a value written by a
